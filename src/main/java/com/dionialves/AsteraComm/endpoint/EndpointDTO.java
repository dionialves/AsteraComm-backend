...
public class EndpointDTO {
    ...
    public EndpointDTO(String id, String callerid, String username, String password, String ip, String rtt,
            Boolean online) {
        this.id = id;
        this.callerid = callerid;
        this.username = username;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(callerid, that.callerid)
